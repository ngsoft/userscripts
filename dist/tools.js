 ...
 * @license RequireJS (GM Edition) 2.4.0 Copyright jQuery Foundation and other contributors.
...
(function(global, setTimeout){
    ...
    var req, s, head, baseElement, dataMain, src, require,
     ...
     */
    requirejs = global.requirejs = req = function(deps, callback, errback, optional){
     ...
     * name.
     */
    define = global.define = function(name, deps, callback){
        var node, context;
